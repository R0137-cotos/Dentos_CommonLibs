...
public interface CommunicationRepository extends CrudRepository<Communication, Long> {
	...
	public List<Communication> findByProcessCategoryAndLoginUserMomEmployeeIdAndAppId(@Param("PROCESS_CATEGORY") String processCategory, @Param("MOM_EMPLOYEE_ID") String momEmployeeId, @Param("APP_ID") List<String> appId);
}
