...
public class BillingCustomerInfo {
	...
	@ApiModelProperty(value = "法人格付企業名_漢字", required = true, position = 33, allowableValues = "range[0,1326]")
	private String cstKnjiNm;

	@ApiModelProperty(value = "事業所名_漢字", required = true, position = 34, allowableValues = "range[0,1326]")
