...
public class ContractOperationLog extends EntityBase {
	...
	public enum OperationLogType {
		売上開始指示, 売上計上開始, 売上計上停止, キャンセル手続き, キャンセル中止, 解約手続き, 解約確定, 解約取込, 解約手続き中止, 変更キャンセル, 変更確定, 新規作成, 帳票出力, 契約変更, 確定, 情報変更, 新規作成_情報変更, 更新, 業務依頼, 業務処理完了, 締結開始指示, 新規作成_契約変更, 自動更新, 移行データ_新規作成, 移行データ_更新, 承認済差戻, 破棄, 企業情報更新
	}
