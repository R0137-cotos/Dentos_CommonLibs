...
public interface EstimationChecklistCompMasterRepository extends CrudRepository<EstimationChecklistCompMaster, Long> {
	...
	public List<EstimationChecklistCompMaster> findByProductMasterIdAndTargetEstimationTypeAndTargetLifecycleStatus(@Param("product_master_id") Long productMasterId, @Param("target_estimation_type") String targetEstimationType, @Param("target_lifecycle_status") Long targetLifecycleStatus);
