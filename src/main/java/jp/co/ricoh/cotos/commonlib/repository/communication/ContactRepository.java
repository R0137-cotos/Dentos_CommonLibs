...
public interface ContactRepository extends CrudRepository<Contact, Long> {
	...
	public List<Contact> findByEstimationIdAndServiceCategoryAndParentIdIsNullAndAppIdOrderByIdDesc(@Param("ESTIMATION_ID") long estimationId, @Param("SERVICE_CATEGORY") String serviceCategory, @Param("APP_ID") List<String> appId);
}
