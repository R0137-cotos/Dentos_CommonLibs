...
public class EstimationApprovalRoute extends EntityBase {
	...
	@Id
	@ApiModelProperty(value = "見積承認ルートID", required = true, position = 1, allowableValues = "range[0,9999999999999999999]", readOnly = true)
	private long id;
	...
	@ApiModelProperty(value = "見積承認実績", required = false, position = 7)
