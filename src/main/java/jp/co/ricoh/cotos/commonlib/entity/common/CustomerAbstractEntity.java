...
public class CustomerAbstractEntity extends EntityBase {
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "事業所名", required = false, position = 58, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "部門名", required = false, position = 59, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "郵便番号", required = false, position = 60, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 1000)
	@ApiModelProperty(value = "住所", required = false, position = 61, allowableValues = "range[0,1000]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "電話番号", required = false, position = 62, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "FAX番号", required = false, position = 63, allowableValues = "range[0,255]")
