...
public class ContractListInfo {
	 ...
	 * 見積ID
	 */
	@ApiModelProperty(value = "見積ID", required = true, position = 7)
	...
	@ApiModelProperty(value = "見積番号<br />" //
			+ "見積番号 + \"-\" + 見積番号枝番", //
			required = false, position = 8, allowableValues = "range[0,18]") //
	 ...
	 * 案件番号
	 */
	@ApiModelProperty(value = "案件番号", required = false, position = 10, allowableValues = "range[0,255]")
	private String caseNumber;

	/**
	 * 請求開始月
	 */
	@ApiModelProperty(value = "請求開始月", required = false, position = 11)
	...
	@ApiModelProperty(value = "サービス開始日", required = false, position = 15)
	 ...
	 */
	@Temporal(TemporalType.TIMESTAMP)
	@ApiModelProperty(value = "サービス終了日", required = false, position = 16)
	private Date serviceTermEnd;

	/**
	 * 商品名称
	 */
	@ApiModelProperty(value = "商品名称", required = false, position = 17, allowableValues = "range[0,255]")
	private String productName;

	/**
	 * 担当営業氏名
	 */
	@ApiModelProperty(value = "担当営業氏名", required = false, position = 18, allowableValues = "range[0,255]")
	private String picEmptxName;

	/**
	 * 担当支社名
	 */
	@ApiModelProperty(value = "担当支社名", required = false, position = 19, allowableValues = "range[0,255]")
