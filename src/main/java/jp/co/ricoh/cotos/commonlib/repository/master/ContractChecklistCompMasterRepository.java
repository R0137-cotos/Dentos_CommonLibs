...
public interface ContractChecklistCompMasterRepository extends CrudRepository<ContractChecklistCompMaster, Long> {
	...
	public ContractChecklistCompMaster findByProductMasterIdAndTargetContractTypeAndTargetLifecycleStatus(@Param("product_master_id") Long productMasterId, @Param("target_contract_type") String targetContractType,@Param("target_lifecycle_status") Long targetLifecycleStatus);
