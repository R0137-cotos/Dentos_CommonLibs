...
public class Contract extends EntityBase {
	...
	@ApiModelProperty(value = "契約チェック結果(作成時不要)", required = false, position = 41, readOnly = true)
	 ...
	 */
	@OneToMany(mappedBy = "contract")
	@ApiModelProperty(value = "契約承認ルート(作成時不要)", required = false, position = 42, readOnly = true)
	 ...
	 */
	@OneToMany(mappedBy = "contract")
	@ApiModelProperty(value = "契約添付ファイル(作成時不要)", required = false, position = 43, readOnly = true)
	 ...
	 */
	@OneToMany(mappedBy = "contract")
	@ApiModelProperty(value = "契約追加編集者社員(作成時不要)", required = false, position = 45, readOnly = true)
	...
	@ApiModelProperty(value = "契約操作履歴(作成時不要)", required = true, position = 48, readOnly = true)
	 ...
	 */
	@OneToOne(mappedBy = "contract")
	@ApiModelProperty(value = "契約担当CE社員(作成時不要)", required = false, position = 50, readOnly = true)
	 ...
	 */
	@OneToOne(mappedBy = "contract")
	@ApiModelProperty(value = "契約保守担当SS組織(作成時不要)", required = false, position = 51, readOnly = true)
