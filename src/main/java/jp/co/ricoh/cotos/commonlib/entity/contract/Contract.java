...
//	 private long productGrpMasterId;
	...
	@ApiModelProperty(value = "商品グループマスタ", required = false, position = 6)
	 ...
	 */
	@Column(nullable = false)
	@ApiModelProperty(value = "契約番号", required = true, position = 10, allowableValues = "range[0,255]", readOnly = true)
	 ...
	 */
	@Column(nullable = false)
	@ApiModelProperty(value = "契約番号枝番", required = true, position = 11, allowableValues = "range[0,99]", readOnly = true)
	 ...
	 */
	@Column(nullable = false)
	@ApiModelProperty(value = "見積番号", required = true, position = 24, allowableValues = "range[0,255]")
	 ...
	 */
	@Column(nullable = false)
	@ApiModelProperty(value = "見積番号枝番", required = true, position = 25, allowableValues = "range[0,99]")
	private int estimationBranchNumber;

	/**
	 * 見積ID
	 */
	@ApiModelProperty(value = "見積ID", required = true, position = 26, allowableValues = "range[0,99999999999999999999]")
	...
	@ApiModelProperty(value = "契約明細", required = true, position = 35)
	 ...
	 */
	@OneToMany(mappedBy = "contract")
	@ApiModelProperty(value = "契約チェック結果", required = false, position = 36)
	 ...
	 */
	@OneToMany(mappedBy = "contract")
	@ApiModelProperty(value = "契約承認ルート", required = false, position = 37)
	 ...
	 */
	@OneToMany(mappedBy = "contract")
	@ApiModelProperty(value = "契約添付ファイル", required = false, position = 38)
	...
	@ApiModelProperty(value = "契約担当SA社員", required = true, position = 39)
	 ...
	 */
	@OneToMany(mappedBy = "contract")
	@ApiModelProperty(value = "契約追加編集者社員", required = false, position = 40)
	 ...
	 */
	@OneToMany(mappedBy = "contract")
	@ApiModelProperty(value = "販売店(契約用)", required = false, position = 41)
	 ...
	 */
	@OneToOne(mappedBy = "contract")
	@ApiModelProperty(value = "顧客(契約用)", required = true, position = 42)
	 ...
	 */
	@OneToMany(mappedBy = "contract")
	@ApiModelProperty(value = "契約操作履歴", required = true, position = 43, readOnly = true)
	 ...
	 */
	@OneToMany(mappedBy = "contract")
	@ApiModelProperty(value = "商品(契約用)", required = true, position = 44)
