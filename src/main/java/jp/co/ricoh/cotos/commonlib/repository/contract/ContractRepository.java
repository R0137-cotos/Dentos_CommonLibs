...
public interface ContractRepository extends CrudRepository<Contract, Long> {
	...
	@Query(value = "SELECT * FROM CONTRACT WHERE (CONTRACT_TYPE = '3' AND LIFECYCLE_STATUS = '5' AND CHANGE_PREFERRED_DATE <= :preferredDate) OR ((CONTRACT_TYPE = '1' OR CONTRACT_TYPE = '2') AND LIFECYCLE_STATUS = '11' AND CONCLUSION_PREFERRED_DATE <= :preferredDate) ORDER BY ID", nativeQuery = true)
	...
	public List<Contract> findByCaseNumber(String caseNumber);
