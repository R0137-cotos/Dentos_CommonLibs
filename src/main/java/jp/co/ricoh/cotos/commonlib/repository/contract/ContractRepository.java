...
public interface ContractRepository extends CrudRepository<Contract, Long> {
	...
	@Query(value = "SELECT * FROM CONTRACT WHERE (CONTRACT_TYPE = '1' OR CONTRACT_TYPE = '2') AND LIFECYCLE_STATUS = '11' AND CONCLUSION_PREFERRED_DATE <= :conclusionPreferredDate", nativeQuery = true)
	public List<Contract> findByContractTypeAndConclusionPreferredDate(@Param("conclusionPreferredDate") Date conclusionPreferredDate);
}
