...
public class TestFindProperties {
	...
	public void プロパティ取得() {
		...
		Assert.assertEquals("DB設定：ユーザー名が正しく取得されること", "cotos_ci_commonlibs_rsi", appProperties.getDatasourceProperties().getUsername());
		Assert.assertEquals("DB設定：パスワードが正しく取得されること", "cotos_ci_commonlibs_rsi", appProperties.getDatasourceProperties().getPassword());
