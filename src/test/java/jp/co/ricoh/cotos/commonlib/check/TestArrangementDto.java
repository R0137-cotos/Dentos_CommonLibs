...
public class TestArrangementDto {
	...
	public void ArrangementWorkDtoのテスト() throws Exception {
		ArrangementWork entity = arrangementWorkRepository.findOne(4L);
		...
		// 異常系（@Valid：）
		BeanUtils.copyProperties(dto, testTarget);
//		testTarget.getArrangement().setDetailAbstract(STR_256);
...
//		testTarget.getEstimationCheckResultList().get(0).setCheckedUserName(STR_256);
	...
	public void ArrangementDtoのテスト() throws Exception {
		Arrangement entity = arrangementRepository.findOne(401L);
	...
	@Test
	public void ArrangmentApprovalRouteDtoのテスト() throws Exception {
